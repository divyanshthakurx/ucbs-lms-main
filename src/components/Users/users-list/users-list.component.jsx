            ...
            <div className="bg-black w-full rounded-t-2xl text-white">
                <div className="py-6 px-10 flex justify-between items-center gap-1">
                    ...
                    <div>
                        <div className="flex">
                            <div>
                                <input className="text-black w-[23rem] h-11 rounded-l-xl px-4" onChange={handleChange} type="search" id="search" name="search" placeholder="user name"/>
                            </div>      
                            <div className="w-[2.75rem] p-1 align-middle bg-white rounded-r-xl">
