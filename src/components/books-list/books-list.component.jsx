...
const BooksList = () => {
  ...
  const filteredList = currentBook && currentBook.filter(book => book.name.toLowerCase().includes(userSearch.toLowerCase()));
    ...
    <>
      <div className="mt-12 ml-12">
        ...
        <div className="relative mt-5">
          <select className="block appearance-none w-52 bg-white border border-gray-200 text-gray-700 py-3 px-4 pr-8 rounded leading-tight focus:outline-none focus:bg-white focus:border-gray-500">
